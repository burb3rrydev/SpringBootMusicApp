...
public class ProductController {
    ...
    public String showProductForm(Model model) {
        ...
        return "createProduct"; // Create a Thymeleaf template for product creation
    }
    ...
    public String createProduct(@ModelAttribute("product") MusicProduct product,
        ...
        product.setAudioFile(audioFile);
        product.setPicture(picture);

        musicProductService.saveProduct(product);
        return "redirect:/music"; // Redirect to the music page after product creation
    }
}
